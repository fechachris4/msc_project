...
- **`controller/kinematics.py`** — rigid-transform helpers and the right-EE FK composition `T_W_T · T_T_KR · T_KR_E` (world → torso mocap → Kinova base → EE site), validated against MuJoCo's direct site pose in `tests/test_kinematics.py`.
