...
Cases ported from the hardware controller's router tests, plus direct,
clockwise, counter-clockwise, over, inside-target, exact-boundary, disabled,
waypoint-advancement and opposite-sides cases.
